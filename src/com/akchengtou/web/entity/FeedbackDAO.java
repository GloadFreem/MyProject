 ...
 * 
 * @see com.akchengtou.web.entity.Feedback
...
public class FeedbackDAO {
	...
	public Feedback findById(java.lang.Integer id) {
		...
		try {
			Feedback instance = (Feedback) getCurrentSession().get(
					"com.akchengtou.web.entity.Feedback", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Feedback> findByExample(Feedback instance) {
		...
		try {
			List<Feedback> results = (List<Feedback>) getCurrentSession()
					.createCriteria("com.akchengtou.web.entity.Feedback")
