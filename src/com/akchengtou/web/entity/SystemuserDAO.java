 ...
 * 
 * @see com.akchengtou.web.entity.Systemuser
...
public class SystemuserDAO {
	...
	public Systemuser findById(java.lang.Integer id) {
		...
		try {
			Systemuser instance = (Systemuser) getCurrentSession().get(
					"com.akchengtou.web.entity.Systemuser", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Systemuser> findByExample(Systemuser instance) {
		...
		try {
			List<Systemuser> results = (List<Systemuser>) getCurrentSession()
					.createCriteria("com.akchengtou.web.entity.Systemuser")
	...
	public List<Systemuser> findByRoleTypeId(Object roleTypeId) {
		return findByProperty(ROLE_TYPE_ID, roleTypeId);
	}
	...
	public List<Systemuser> findByAccount(Object account) {
