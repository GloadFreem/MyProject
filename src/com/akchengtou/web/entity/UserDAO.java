 ...
 * 
 * @see com.akchengtou.web.entity.User
...
public class UserDAO {
	...
	public User findById(java.lang.Integer id) {
		...
		try {
			User instance = (User) getCurrentSession().get(
					"com.akchengtou.web.entity.User", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<User> findByExample(User instance) {
		...
		try {
			List<User> results = (List<User>) getCurrentSession()
					.createCriteria("com.akchengtou.web.entity.User")
	...
	public List<User> findByIntroduce(Object introduce) {
