...
public class TenpayHttpClient {
	...
	/**
	 * 请求方法：获取微信支付预支付prepayid
	 * 
	 * @param map
	 * 
	 */

	public String getPrepayId(String xmlStr) {
		HttpClient client = new HttpClient();
		// 创建post请求方法
		PostMethod myPost = new PostMethod(AlipayConfig.API_CHECK);
		// 设置请求超时时间
		...
		try {
			...
			myPost.setRequestEntity((RequestEntity) new StringRequestEntity(
					xmlStr));
