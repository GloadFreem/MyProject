	...
	<section class="vbox">
		<section class="scrollable padder">
			<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
				...
				<li><a href="index.action"><i class="fa"></i> 圈子管理</a></li>
				<li><a href="index.action"><i class="fa"></i> 圈子列表</a></li>
			</ul>
			<section class="panel panel-default">
				<header class="panel-heading"> 圈子列表 </header>
								...
								<c:when test="${result != null}">
									<c:forEach items="${result}" var="item" varStatus="status">
										<tr>
											...
											<td>${item.content}</td>
											<td><c:forEach var="image" items="${item.publiccontentimageses}">
											...
											<td><a
												...
												data-href="deleteFeeling.action?contentId=${item.contentId }&menu=5&sortmenu=1&submenu=1&page=0&size=10"
...
<script type="text/javascript">
	$("a[name='page']").click(
			function() {
				...
				var submenu = ${submenu};
				var url = "feelingList.action?" + "size=" + size + "&page=" + page
