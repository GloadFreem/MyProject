	...
	<section class="vbox">
		<section class="scrollable padder">
			<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
				...
				<li><a href="index.action"><i class="fa"></i> 消息管理</a></li>
				<li><a href="index.action"><i class="fa"></i> 消息列表</a></li>
			</ul>
								...
								<c:when test="${result != null}">
									<c:forEach items="${result}" var="item" varStatus="status">
										<tr>
											...
											<td><a
												href="messageDetail.action?contentId=${item.messageId }&menu=7&sortmenu=2&submenu=1&page=0&size=10"
												class="active"><i
													class="fa fa-edit text-success text-active"></i><i
													class="fa fa-edit text-danger text"></i></a> | <a href="#modal"
												data-href="deleteMessage
												.action?contentId=${item.messageId }&menu=7&sortmenu=2&submenu=1&page=0&size=10"
...
<script type="text/javascript">
	$("a[name='page']").click(
			function() {
				...
				var submenu = ${submenu};
				var url = "messageList.action?" + "size=" + size + "&page=" + page
