	...
	<section class="vbox">
		<section class="scrollable padder">
			<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
				...
				<li><a href="index.action"><i class="fa"></i> 公告管理</a></li>
				<li><a href="index.action"><i class="fa"></i> 公告列表</a></li>
			</ul>
			<section class="panel panel-default">
				<header class="panel-heading"> 公告列表 </header>
									...
									<c:forEach items="${result}" var="item" varStatus="status">
										<tr>
											...
											<td><a
												...
												data-href="deleteAnnounce.action?contentId=${item.announceId }&menu=7&sortmenu=1&submenu=1&page=0&size=10"
...
<script type="text/javascript">
	$("a[name='page']").click(
			function() {
				...
				var submenu = ${submenu};
				var url = "announceList.action?" + "size=" + size + "&page=" + page
